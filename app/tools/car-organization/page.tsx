...
const guides = [
  {
    ...
    description: "Trunk organizers that keep grocery bags separated, reduce rolling items, and make repeated deliveries easier.",
    href: "/tools/car-organization/best-car-trunk-organizers",
    status: "Coming Soon",
  },
  {
    title: "Best Back Seat Organizers",
    eyebrow: "Cabin Setup",
    description: "Seat-back and cabin organizers for chargers, snacks, receipts, supplies, and small delivery essentials.",
    href: "/tools/car-organization/best-back-seat-organizers",
    status: "Coming Soon",
  },
  {
    title: "Best Cargo Bins for Delivery Drivers",
    eyebrow: "Storage",
    description: "Simple bins and crates for keeping grocery orders stable, separated, and easier to unload.",
    href: "/tools/car-organization/best-cargo-bins",
    status: "Coming Soon",
  },
  {
    title: "Best Cleaning Supplies for Delivery Cars",
    eyebrow: "Maintenance",
    description: "Practical cleaning supplies to help keep your vehicle presentable during grocery and package delivery work.",
    href: "/tools/car-organization/best-car-cleaning-supplies",
    status: "Coming Soon",
  }
];
      ...
      <section className="relative overflow-hidden rounded-[2.5rem] bg-slate-950 p-8 text-white shadow-[0_32px_120px_rgba(15,23,42,0.22)] md:p-12 lg:p-14">
        ...
        <div className="relative max-w-3xl">
          <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm font-semibold text-slate-300">
            ...
            <span className="text-slate-200">Car Organization</span>
          </nav>
          ...
          <h1 className="mt-8 text-5xl font-black tracking-[-0.05em] text-white md:text-6xl lg:text-7xl">
            Car Organization for Spark Drivers
          </h1>

          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Storage bins, trunk organizers, seat organizers, and setup ideas that help keep delivery vehicles cleaner and easier to work from.
          </p>
          ...
          <div className="mt-8 hidden gap-4 md:grid md:grid-cols-2">
            ...
            <div className="rounded-3xl bg-white/10 p-5 ring-1 ring-white/15 backdrop-blur">
              ...
              <p className="mt-2 text-2xl font-black">Clean setup</p>
            </div>
          </div>
        </div>
      </section>
