...
const guides = [
  {
    ...
    eyebrow: "Live Guide",
    description: "Reliable dash cams for documenting driving, protecting yourself after incidents, and adding peace of mind during delivery work.",
    href: "/tools/safety-equipment/best-dash-cams",
    status: "Live",
  },
  {
    title: "Best Flashlights for Delivery Drivers",
    eyebrow: "Night Driving",
    description: "Compact flashlights for evening deliveries, dark porches, apartments, and emergency roadside situations.",
    href: "/tools/safety-equipment/best-flashlights",
    status: "Coming Soon",
  },
  {
    title: "Best Reflective Safety Gear",
    eyebrow: "Visibility",
    description: "Reflective vests, bands, and visibility gear for drivers working at night or near traffic.",
    href: "/tools/safety-equipment/best-reflective-gear",
    status: "Coming Soon",
  },
  {
    title: "Best Emergency Warning Lights",
    eyebrow: "Roadside",
    description: "Small warning lights and safety tools for roadside problems, low visibility, and emergency stops.",
    href: "/tools/safety-equipment/best-emergency-warning-lights",
    status: "Coming Soon",
  }
];
      ...
      <section className="relative overflow-hidden rounded-[2.5rem] bg-slate-950 p-8 text-white shadow-[0_32px_120px_rgba(15,23,42,0.22)] md:p-12 lg:p-14">
        ...
        <div className="relative max-w-3xl">
          <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm font-semibold text-slate-300">
            ...
            <span className="text-slate-200">Safety Equipment</span>
          </nav>
          ...
          <h1 className="mt-8 text-5xl font-black tracking-[-0.05em] text-white md:text-6xl lg:text-7xl">
            Safety Equipment for Spark Drivers
          </h1>

          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Dash cams, lighting, reflective gear, and driver safety products that can help protect your vehicle, your records, and your peace of mind.
          </p>
          ...
          <div className="mt-8 hidden gap-4 md:grid md:grid-cols-2">
            ...
            <div className="rounded-3xl bg-white/10 p-5 ring-1 ring-white/15 backdrop-blur">
              ...
              <p className="mt-2 text-2xl font-black">Driver safety</p>
            </div>
          </div>
        </div>
      </section>
